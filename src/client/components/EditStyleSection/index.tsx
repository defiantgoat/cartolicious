...
import { Select, FormControl, Checkbox } from "@material-ui/core";
import {
  CartoliciousFill,
  CartoliciousStroke,
  ReduxStateConfigProps,
} from "../../interfaces";
import { setCaroliciousStyles } from "../../actions";
...
const EditStyleSection: React.FC = () => {
  ...
  const createOptions = (): JSX.Element[] => {
    const options = [
      <option value={-1} key="select-an-attribute">Select an Attribute</option>,
    ] as JSX.Element[];
